...
export default function MobileBottomNav({ view, setView, onMore, activeInspection, moreOpen }) {
  const items = [
  ...
  const moreActive = moreOpen || ["inspection", "reports", "corporate", "inspectors"].includes(view);
